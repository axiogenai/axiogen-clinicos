        ...
        <div style={{ display: 'flex', height: '175mm', width: '220mm', overflow: 'hidden', borderTop: printOnStationery ? 'none' : '3px double #a53b3b' }}>
          ...
          <aside
            style={{
              ...
              boxSizing: 'border-box',
              overflow: 'hidden',
              display: printOnStationery ? 'none' : 'flex',
              flexDirection: 'column',
              justifyContent: 'space-between',
            }}
          >
          ...
          <main
            style={{
              width: printOnStationery ? '200mm' : '145mm',
              minWidth: printOnStationery ? '200mm' : '145mm',
              maxWidth: printOnStationery ? '200mm' : '145mm',
              height: '175mm',
              padding: printOnStationery ? '3mm 6mm 3mm 20mm' : '3mm 6mm',
              position: 'relative',
              display: 'flex',
              flexDirection: 'column',
              justifyContent: 'space-between',
