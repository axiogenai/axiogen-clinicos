...
export const medicines: Medicine[] = [
  // Antibiotics
  { id: 'med_ab_01', name: 'Amoxicillin', strength: '500mg', form: 'Capsule', defaultFrequency: 'TDS (1-1-1)', defaultDuration: '5 Days' },
  { id: 'med_ab_02', name: 'Azithromycin', strength: '500mg', form: 'Tablet', defaultFrequency: 'OD (0-1-0)', defaultDuration: '3 Days' },
  { id: 'med_ab_03', name: 'Doxycycline', strength: '100mg', form: 'Capsule', defaultFrequency: 'BD (1-0-1)', defaultDuration: '14 Days' },
  { id: 'med_ab_04', name: 'Cephalexin', strength: '500mg', form: 'Capsule', defaultFrequency: 'BD (1-0-1)', defaultDuration: '5 Days' },
  { id: 'med_ab_05', name: 'Erythromycin', strength: '250mg', form: 'Tablet', defaultFrequency: 'QID (1-1-1-1)', defaultDuration: '7 Days' },
  { id: 'med_ab_06', name: 'Clarithromycin', strength: '250mg', form: 'Tablet', defaultFrequency: 'BD (1-0-1)', defaultDuration: '7 Days' },
  { id: 'med_ab_07', name: 'Linezolid', strength: '600mg', form: 'Tablet', defaultFrequency: 'BD (1-0-1)', defaultDuration: '7 Days' },
  { id: 'med_ab_08', name: 'Clindamycin', strength: '300mg', form: 'Capsule', defaultFrequency: 'TDS (1-1-1)', defaultDuration: '5 Days' },
  { id: 'med_ab_09', name: 'Minocycline', strength: '50mg', form: 'Capsule', defaultFrequency: 'OD (0-1-0)', defaultDuration: '30 Days' },
  
  // Antifungals
  { id: 'med_af_01', name: 'Fluconazole', strength: '150mg', form: 'Tablet', defaultFrequency: 'Once weekly', defaultDuration: '4 Weeks' },
  { id: 'med_af_02', name: 'Itraconazole', strength: '100mg', form: 'Capsule', defaultFrequency: 'BD (1-0-1)', defaultDuration: '2 Weeks' },
  { id: 'med_af_03', name: 'Terbinafine', strength: '250mg', form: 'Tablet', defaultFrequency: 'OD (1-0-0)', defaultDuration: '4 Weeks' },
  { id: 'med_af_04', name: 'Griseofulvin', strength: '250mg', form: 'Tablet', defaultFrequency: 'BD (1-0-1)', defaultDuration: '4 Weeks' },
  { id: 'med_af_05', name: 'Clotrimazole', strength: '1%', form: 'Cream', defaultFrequency: 'BD', defaultDuration: '2 Weeks' },
  { id: 'med_af_06', name: 'Ketoconazole', strength: '2%', form: 'Shampoo', defaultFrequency: 'Twice a week', defaultDuration: '4 Weeks' },
  { id: 'med_af_07', name: 'Luliconazole', strength: '1%', form: 'Cream', defaultFrequency: 'OD', defaultDuration: '2 Weeks' },
  { id: 'med_af_08', name: 'Ketoconazole', strength: '2%', form: 'Cream', defaultFrequency: 'BD', defaultDuration: '2 Weeks' },
